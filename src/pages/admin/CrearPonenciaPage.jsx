...
export const CrearPonenciaPage = () => {
  ...
  useEffect(() => {
    const nuevoPonente = location.state?.nuevoPonente
    if (nuevoPonente) {
      setForm((prev) => ({ ...prev, idPonente: nuevoPonente.id, nombrePonente: nuevoPonente.nombrePonente, emailPonente: nuevoPonente.email }))
      setPonentesData((prev) => ({ ...prev, data: [...(prev?.data || []), nuevoPonente] }))
          ...
          <div className="form-cliente__grid">
            ...
            <label className="form-cliente__field">
              ...
              <div className="form-cliente__ponente-row">
                ...
                <button type="button" className="btn btn--small" onClick={() => navigate('/ponentes/nuevo')} title="Crear nuevo ponente">+</button>
              </div>
            </label>
            <label className="form-cliente__field">
            ...
            <div className="form-cliente__row-duo">
              <label className="form-cliente__field">
                ...
                <input className="input" type="date" name="horarioIdaTransporte__date" value={form.horarioIdaTransporte?.split('T')[0] || ''} onChange={handleChange} />
                <input className="input" type="time" name="horarioIdaTransporte__time" value={form.horarioIdaTransporte?.split('T')[1] || ''} onChange={handleChange} />
              </label>
              <label className="form-cliente__field">
                <span>Transporte Vuelta</span>
                <input className="input" type="date" name="horarioVueltaTransporte__date" value={form.horarioVueltaTransporte?.split('T')[0] || ''} onChange={handleChange} />
                <input className="input" type="time" name="horarioVueltaTransporte__time" value={form.horarioVueltaTransporte?.split('T')[1] || ''} onChange={handleChange} />
              </label>
            </div>
            <label className="form-cliente__field">
              <span>Fecha inicio *</span>
              <div className="form-cliente__row-duo">
                <input className="input" type="date" name="fechaInicio__date" value={form.fechaInicio?.split('T')[0] || ''} onChange={handleChange} />
                <input className="input" type="time" name="fechaInicio__time" value={form.fechaInicio?.split('T')[1] || ''} onChange={handleChange} />
              </div>
            </label>
            <label className="form-cliente__field">
              <span>Fecha fin *</span>
              <div className="form-cliente__row-duo">
                <input className="input" type="date" name="fechaFin__date" value={form.fechaFin?.split('T')[0] || ''} onChange={handleChange} />
                <input className="input" type="time" name="fechaFin__time" value={form.fechaFin?.split('T')[1] || ''} onChange={handleChange} />
              </div>
            </label>
